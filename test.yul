    ...
    object "runtime" {
        code {
            ...
            case 0x156e29f6 /* "mint(address,uint256,uint256)" */ { 
                // secondary mint function with no need to pass in bytes data
                // blank generated bytes data
                let bytesData := genBlankbytes()      
            ...
            */
            ...
            function genBlankbytes() {
                // bytes data (with size porition preceding data)
            }
